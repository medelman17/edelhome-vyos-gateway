...
set firewall group interface-group IG_management interface 'eth0.9'
...
# # MQTT client devices
# set firewall group address-group mqtt_clients address '10.10.20.21' # Bernd
...
# # Unifi devices
# set firewall group address-group unifi_devices address '10.10.9.11-10.10.9.13' # Switches
# set firewall group address-group unifi_devices address '10.10.9.21-10.10.9.24' # AP's
