...
set container name lego-auto environment LA_EMAIL value 'postmaster@home.edel.host'
set container name lego-auto environment LA_PROVIDER value 'cloudflare'
set container name lego-auto environment LA_DOMAINS value '*.home.edel.host'
set container name lego-auto environment CF_DNS_API_TOKEN value "${CLOUDFLARE_DNS_API_TOKEN}"
set container name lego-auto volume datadir source '/config/secrets/certs/_.home.edel.host'
...
set container name pihole environment PIHOLE_DOMAIN value 'home.edel.host'
set container name pihole environment WEBPASSWORD value "${PIHOLE_WEBPASSWORD}"
...
set container name pihole environment REV_SERVER_DOMAIN value 'home.edel.host'
